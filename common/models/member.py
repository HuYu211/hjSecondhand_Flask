...
class Member(db.Model):
    ...
    qq = db.Column(db.String(11), nullable=False, server_default=db.FetchedValue())
    hjStudentID = db.Column(db.String(20), nullable=False, server_default=db.FetchedValue())
